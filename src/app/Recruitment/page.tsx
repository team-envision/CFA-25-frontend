...
const RecruitmentForm: React.FC = () => {
  ...
  const selectContentStyle = "min-w-[var(--radix-select-trigger-width)] max-h-[300px] overflow-y-auto bg-neutral-900 backdrop-blur-md border border-neutral-700 text-white rounded-xl shadow-2xl z-50";
      ...
      <div className="min-h-screen relative bg-black flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-10 max-w-[60vw] sm:max-w-none">
          <div className="px-0 py-[2px] rounded-full bg-gradient-to-b from-neutral-500 to-neutral-800">
            <Button variant="secondary" className="rounded-full px-5 py-2 sm:py-3 lg:py-4 bg-neutral-900 text-white border border-neutral-800 hover:bg-neutral-800 text-[10px] sm:text-sm" onClick={() => window.open("https://aaruush.org", "_blank")}>
              Visit Our Website
            </Button>
          </div>
        </div>
        ...
        <div className="w-full max-w-[780px] mt-4 z-10 px-2 sm:px-0">
          <div className="py-px rounded-2xl bg-gradient-to-b from-[#796856] to-[#574030a1]">
            <div className="bg-[#2a170b] rounded-2xl px-3 sm:px-6 py-2.5 text-sm text-neutral-200">
              ...
              <span className="ml-1.5"> The form for Team Envision is separate. To fill <button onClick={handleClick} className="text-orange-500 underline hover:text-orange-400 transition-colors"> Click Here. </button> </span>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <FormField control={form.control} name="regNumber" render={({ field }) => ( 
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="RA..." className={fieldStyle} {...field} />
                  </FormControl>
                  <FormMessage className="text-red-400 text-xs mt-1.5" />
                </FormItem> 
              )}/>
              ...
              <FormField control={form.control} name="branch" render={({ field }) => ( 
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="CSE CORE, CSE AI/ML, etc." className={fieldStyle} {...field} />
                  </FormControl>
                  <FormMessage className="text-red-400 text-xs mt-1.5" />
                </FormItem> 
              )}/>
              ...
              <FormField control={form.control} name="email" render={({ field }) => ( 
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="you@example.com" type="email" className={fieldStyle} {...field} />
                  </FormControl>
                  <FormMessage className="text-red-400 text-xs mt-1.5" />
                </FormItem> 
              )}/>
              ...
              <FormField control={form.control} name="srmEmail" render={({ field }) => ( 
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="ab1234@srmist.edu.in" type="email" className={fieldStyle} {...field} />
                  </FormControl>
                  <FormMessage className="text-red-400 text-xs mt-1.5" />
                </FormItem> 
              )}/>
