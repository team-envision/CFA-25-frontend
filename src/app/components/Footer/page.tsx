...
const Footer = () => {
  return (
    <div className="footer bottom-0 w-[100vw] min-h-[25vh] bg-black z-20 flex flex-col lg:flex-row px-4 sm:px-6 lg:px-[5vw] pt-4 lg:pt-[2vw] pb-4 box-border ">
      {/* Left Section */}
      <div className="left flex flex-col w-full lg:max-w-[33.3%] mb-6 lg:mb-0 items-center lg:-ml-16 lg:mr-10">
        ...
        <div className="logos flex justify-center items-center gap-7 w-full max-w-[250px] mt-1.5 mx-auto">
          ...
          <Link
            href="https://linktr.ee/Aaruushconnect"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:opacity-80 transition-opacity"
          >
            <Smartphone strokeWidth={2} size={18} />
          </Link>
        </div>
      </div>
      {/* Middle Section */}
      <div className="middle text-white p-2 flex flex-col justify-center w-full lg:flex-1 mb-6 lg:mb-0 text-center lg:text-left lg:-ml-6">
        <h2 className="text-base sm:text-xl font-bold mb-2 lg:-mt-5">
          Contact Us
        </h2>
      ...
      <div className="right flex flex-col w-full lg:w-auto items-center lg:items-end flex-shrink-0 lg:justify-self-end lg:translate-x-6 mb-6 lg:mb-0">
        ...
        <div className="logos flex justify-center items-center gap-7 w-full max-w-[250px] mt-1.5 mx-auto">
          ...
          <Link
            href="linkedin.com/company/team-envision/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:opacity-80 transition-opacity"
          >
          ...
          <Link
            href="https://www.instagram.com/teamenvision_srm?igsh=enN2azU2dGdqaWU3"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:opacity-80 transition-opacity"
          >
