...
const Footer = () => {
  return (
    <div className="footer bottom-0 w-full min-h-[25vh] bg-[#000000] z-10 flex flex-col lg:flex-row px-4 sm:px-6 lg:px-[5vw] pt-4 lg:pt-[2vw] pb-4 box-border overflow-hidden">
      {/* Left Section */}
